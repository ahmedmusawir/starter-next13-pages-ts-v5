...
const RadixOneContent = () => {
  return (
    <>
      ...
      {/* Row 4 */}
      <Flex className="flex-wrap gap-4">
        <Container className="w-full sm:w-1/4 bg-gray-200 p-4">
          <h4>Sidebar</h4>
          <ul>
            <li>Item 1</li>
            <li>Item 2</li>
        ...
        <Container className="w-full sm:w-3/4 bg-purple-300 p-4">
          <h2>Content Title</h2>
          <p>Lorem ipsum dolor sit amet...</p>
          <p>Lorem ipsum dolor sit amet...</p>
          <p>Lorem ipsum dolor sit amet...</p>
      ...
      <Flex className="gap-4 flex-wrap mt-5">
        {[...Array(4)].map((_, index) => (
          <Box key={index} className="p-4 bg-gray-200">
            <img src={`https://picsum.photos/400/200`} alt={`Blog ${index}`} />
